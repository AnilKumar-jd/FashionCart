		...
		<div class="leftContainer">
			<div class="rightContainer1">
				...
				<BR> <span
					...
					href="mJeansAndShort.jsp">Jeans & Shorts</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none; color: black;' href="mShirts.jsp">Shirts</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none; color: black;'
					href="mKurta And Kurtara.jsp">Kurta & Kurtases</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none; color: black;' href="mSuits.jsp">Suits</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none; color: black;'
					href="mBlazerAndCoats.jsp">Coat & Blazer</a><BR>
				</span>
			</div>
			<img style="margin-left: 46px; margin-top: 10px;"
				src="imageW/mcoat.jpg">
			<p style="margin-left: 46PX; margin-right: 105px;">EXQUISITE
				...
				<img style="margin-left:46px;margin-top:10px;"src="imageW/mcoat2.jpg"><p style="margin-left:46PX;margin-right:105px;">ALL THE LATEST TRENDS UNDER ONE ROOF<br>
...
This will help you set up your home the way you envisioned, conveniently from your home</p>
		...
		<div class="rightContainer">
			<p style="font-weight:; font-family: verdana; font-size: 11px;">
				<h7 style='font-weight:bold;font-size:13px;'>Coat & Blazer</h7>
