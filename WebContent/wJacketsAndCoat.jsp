	...
	<div id="Allcontainer">
		<div class="leftContainer">
			<div class="rightContainer1">
				<h7
					style='margin-left:90px; font-weight:bold;color:black;font-size: 16px;'>CATOGARIES</H7>
				<BR> <span
			...
			<img style="margin-left: 46px; margin-top: 10px;"
				src="imageW/wjct1.jpg">
			<p style="margin-left: 46PX; margin-right: 105px;">
				ALL THE LATEST TRENDS UNDER ONE ROOF<br> Haven’t we all
				wondered where we could get our favourite celebrity or fashion
				icons’ latest looks? Sure, they have an entourage of personal
				stylists, makeup artists and hair dressers to look the way they do
				but with FashionCart, you will understand that you do not have to
				spend a fortune to look great. There is something for the whole
				family and you can engage in online shopping for women, men and
				kids. Choose from the widest spread of western wear, traditional
				clothing, casual wear, lounge or sleep wear, sports or active wear,
				formal wear, lingerie and more in the clothing section. Footwear of
				numerous kinds, watches, sunglasses, bags, jewellery, scarves and
				stoles, beauty, skin and hair care products, fragrances, and so much
				more are just some of the other items you can grab hold of here.
				Shop online for Home décor and furnishing, including bedding, rugs
				and mats, kitchenware, curtains, lamps, paintings, and more. This
				will help you set up your home the way you envisioned, conveniently
				from your home
			</p>
		...
		<div class="rightContainer">
			<p style="font-weight:; font-family: verdana; font-size: 11px;">
				<h7 style='font-weight:bold;font-size:13px;'>Jackets and Coat</h7>
