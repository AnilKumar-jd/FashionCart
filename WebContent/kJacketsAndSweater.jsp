...
<body>
	<div class="Container">
		...
		<div class="menu">
			<div class="homelogo">
				<p style='text-decoration: none; font-weight: bold; margin-left: 46px; margin-top: 24px;
				 font-weight: bold; color: #282c3f; font-size: 21px;'>
			...
			<div class="loginAndAddcart">
					...
					<p style='text-decoration: none; color: #282c3f; font-weight: bold; margin-top: 24px;
					 margin-left: 28px; font-weight: bold; font-size: 21px;'>
	...
	<div id="Allcontainer">
		<div class="leftContainer">
			<div class="rightContainer1">
				<h7 style='margin-left:90px; font-weight:bold;color:black;font-size: 20px;'>CATOGARIES</H7>
				<BR> <span
		...
		<div class="rightContainer">
			<p style="font-weight:; font-family: verdana; font-size: 11px;">
				<h7 style='font-weight:bold;font-size:13px;'>Jackets and Sweater</h7>
