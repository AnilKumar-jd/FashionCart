...
<body>
	...
	<div id="Allcontainer">
		<div class="leftContainer">
			...
			<img style="margin-left: 36px; margin-top: 10px;"
				src="imageW/mshirt2.jpg">
			<p style="margin-left: 46PX; margin-right: 105px;">EXQUISITE
				...
				<img style="margin-left:76px;margin-top:10px;"src="imageW/mshirt.jpg"><p style="margin-left:46PX;margin-right:105px;">ALL THE LATEST TRENDS UNDER ONE ROOF<br>
