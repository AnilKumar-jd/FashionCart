...
<body>
	...
	<div id="Allcontainer">
		<div class="login-body">
			<div class="login-box">
			<p style="font-size: 32px;margin-top: 15px;color: #535766;text-align:center;">Login in FashionCart </p>
    <p style="color: #94969f;TEXT-ALIGN:CENTER;font-size: 12px;"> USING EMAIL</p>
			 ...
			 <table style='margin-left:23px; padding-top: 10px width:391px; height: 230px;'>
					...
					<tr><td colspan="2"><input type="text" class="subHeader2" placeholder="Enter Password"></td></tr>
						...
						<input type="submit" class="subHeader3" value="LOG IN"></td>
						</tr>
						<tr><td colspan="2"></td></tr>
						<tr><td colspan="2"></td></tr>
						<tr style='height: 35px;'>
							<td style='text-align: center; boder: 1px solid;' colspan="2">Yet
								Not Registered!! <a href="CreateACUser.jsp">register here</a>
							</td>
						</tr>
					</table>
				</form>
