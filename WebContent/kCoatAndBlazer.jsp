		...
		<div class="menu">
			<div class="homelogo">
				...
				<p
					...
					<a style='text-decoration: none;' href="index.jsp">FashionCart
					</a>
				</p>
	...
	<div id="Allcontainer">
		...
		<div class="rightContainer">
			<p style="font-weight:; font-family: verdana; font-size: 11px;">
				<h7 style='font-weight:bold;font-size:13px;'>Coat and Blazer</h7>
