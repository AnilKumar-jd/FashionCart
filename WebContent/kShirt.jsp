...
<body>
	<div class="Container">
		...
		<div class="menu">
			<div class="homelogo">
				<p style='text-decoration: none; font-weight: bold; margin-left: 46px;
				 margin-top: 24px; font-weight: bold; color: #282c3f; font-size: 21px;'>
			...
			<div class="loginAndAddcart">
				<p style='text-decoration: none; color: #282c3f; font-weight: bold; margin-top:
				 24px; margin-left: 28px; font-weight: bold; font-size: 21px;'>
				 <a style='text-decoration: none;' href="">Login</a></p>
			</div>
			<div class="loginAndAddcart">
				<p style='text-decoration: none; color: #282c3f; font-weight: bold; margin-top: 24px;
	...
	<div id="Allcontainer">
		<div class="leftContainer">
			<div class="rightContainer1">
				...
				<BR> <span
					...
					<a style='text-decoration: none;' href="kTshirt.jsp">T-Shirts</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none;' href="kJeansAndTrousers.jsp">Jeans
						& Trousers</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none;' href="kShirt.jsp">Shirts</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none;' href="kCoatAndBlazer.jsp">Coat
						& Blazer</a><BR>
				</span> <span
					style='margin-left: 90px; font-size: 17px; color: rgb(40, 44, 63); padding-top: 4px; margin-bottom: 6px; display: inline-block;'>
					<a style='text-decoration: none;' href="kJacketsAndSweater.jsp">Sweater
						& Jackets</a><BR>

				</span>
			</div>
			<img style="margin-left: 46px; margin-top: 10px;"
				src="imageW/kShirt.jpg">
			<p style="margin-left: 46PX; margin-right: 105px;">EXQUISITE
				ETHNIC DRESSES FOR KID There's no way you can escape the
		...
		<div class="rightContainer">
			<p style="font-weight:; font-family: verdana; font-size: 11px;">
				<h7 style='font-weight:bold;font-size:13px;'>Shirts</h7>
